	...
	<div class="all2">	
		<div class="corner" style="background-color: brown;">
			<h2 class="h" style="background-color: blue;">	
					<p style="color:white;text-align:center;"><b>Primary School</b></p>
			</h2>

			<?php

				$select_primary = "SELECT * FROM us WHERE catergory='Primary'";
									 
				$primary = mysqli_query($connection, $select_primary) or die(mysqli_error($connection));
				$count = mysqli_num_rows($primary);
			
			?>	
							
			<?php if ($count == 0): ?>
				<p style="color:white;text-align:center;padding:20px;">
					Sorry, No details of Primary School have been added yet.
				</p>
			<?php else: ?>
				...
				<p style="color:white;text-align:;padding:px;">
					...
					<?php foreach ($primary as $primary): ?>

						<p style="color:white;text-align:;padding-left:20px;margin:40px;">

							<h3 class="h" style="background-color: brown;">
								<p style="color:white;padding-left:20px;"><?php echo e($primary['title']); ?></p>
							</h3>
							<p style="color:white;padding-left:20px;"><?php echo e($primary['description']); ?></p>
							<P style="color:white;padding-left:20px;">
								<a href="download.php?file=<?php echo e($primary['filepath']);?>" style="color:purple;text-decoration: none;">
									<?php echo e($primary['filename']);?><br>
								</a>
							</P>
						</p>
