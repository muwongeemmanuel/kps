	...
	<div class="all2">	
		...
		<div class="corner" style="background-color: brown;">
			<h2 style="background-color: green;">	
					<p class="cc" style="color:white;text-align:center;"><b>Manage Admin</b></p>
			</h2>
					<p style="color:white;text-align:center;">

						<a href="admin.php">
							<button class = "submit" style = "background-color:green;color:white;border-radius:5px;width: 95px;">
								Go Back
							</button>
						</a>
					...
					<?php
							...
							$select_login = "SELECT * FROM `login` WHERE title='others'";
							...
							<table>
									...
									<?php foreach ($result as $admin): ?>
										<tr>
											...
											<td>
												<a href="deleteadmin.php?admin=<?php echo $admin['username']; ?>">
